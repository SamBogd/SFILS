...
print(f"Time Elapsed To Iterate Through All Tables: {(time.time() - startTime):.3f}s")
...
patronCount = myCursor.fetchone()[0] #This is the result of the sum statement execution
...
checkoutTotal = myCursor.fetchone()[0] #This is the result of the sum statement execution
...
renewalTotal = myCursor.fetchone()[0] #This is the result of the sum statement execution
